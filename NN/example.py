...
# model.fit(train_data, train_tags, epochs=1)

test_data = np.array(train_data, dtype=float) 
# print(len(test_tags)) 
# print(len(test_data))

test_loss, test_acc = model.evaluate(test_data[50000:], test_tags) #test_tag is smaller than test_data, size problem
...
wins, losses, ties = test_model( "blackjackmodel.3-2-out", 5000, False, 3, False )
